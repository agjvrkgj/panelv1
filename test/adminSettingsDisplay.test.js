...
test('GET /logs and /sub-stats include display fields', async (t) => {
  const mockDb = {
    ...
    getSubAccessUserDetailV2: (userId, hours) => ({
      summary: {
        request_count: 5,
        ok_count: 5,
        deny_count: 0,
      ...
      ips: [{ ip: '1.1.1.1', ok_count: 1, deny_count: 0, last_access: '2026-02-27 16:30:45' }],
      uas: [],
      reasons: [],
      routes: [],
      timeline: [{ time: '2026-02-27 16:30:45', ip: '1.1.1.1', ua: 'x', route: 'sub', result: 'allow', reason: 'ok', http_status: 200, client_type: '' }],
    }),
